...
class TenantAwareWorker:
    ...
    async def send_notification_channel(
        ...
        provider = provider_class(config=tenant_config or {})
        ...
        self._enforce_sender_identity(channel_name, tenant_config or {})
    ...
    def _enforce_sender_identity(self, channel: str, provider_config: Dict) -> None:
