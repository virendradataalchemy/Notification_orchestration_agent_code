...
async def get_current_usage(
    ...
    """
    allowed, usage_info = await usage_tracker.check_quota(db, tenant_id)
...
async def get_usage_stats(
    ...
    stats = await usage_tracker.get_usage_stats(db, tenant_id, months)
...
async def check_quota_available(
    ...
    """
    allowed, _ = await usage_tracker.check_quota(db, tenant_id)
