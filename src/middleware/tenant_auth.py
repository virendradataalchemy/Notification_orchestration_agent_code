...
class TenantAuthMiddleware(BaseHTTPMiddleware):
        ...
        if not tenant.is_active:
            return JSONResponse(
                ...
                content={
                    ...
                    "message": "This tenant is inactive. Please contact support."
                }
            )
    ...
    async def _authenticate_tenant(self, api_key: str) -> Optional[Tenant]:
        ...
        """
        logger.warning("API-key tenant auth is not supported by the live Supabase schema")
        return None
...
def get_tenant_id(request: Request) -> str:
    ...
    Usage in route:
        ...
        async def get_notifications(tenant_id: str = Depends(get_tenant_id)):
            ...
    """
    # Development fallback: use X-Tenant-ID header
